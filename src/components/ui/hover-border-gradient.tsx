...
>) {
  ...
  return (
    <Tag
      ...
      className={cn(
        'relative flex rounded-2xl border border-zinc-200/70 content-center bg-transparent transition duration-500 items-center flex-col flex-nowrap gap-6 h-min justify-center overflow-visible p-px decoration-clone w-full',
        containerClassName,
      )}
      {...props}
    >
      <div className={cn('w-full z-10 bg-white text-zinc-900 rounded-[inherit]', className)}>{children}</div>
      <motion.div

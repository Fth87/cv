...
// Backward-compatible exports for home page components
export const personalInfo = defaultCvData.personalInfo;
export const education = defaultCvData.education;
export const skills = defaultCvData.skills;
export const experience = defaultCvData.experience;
export const achievements = defaultCvData.achievements;
